export const landingCopy = {
  zh: {
    ...
    chipNoAds: "無廣告",
    chipOffline: "離線可玩",
    badgeSoonTop: "iPhone／iPad 同 Android 版現已推出",
    storeBadgesLabel: "下載廣得好",
    appStoreAria: "喺 App Store 下載廣得好（開新視窗）",
    googlePlayAria: "喺 Google Play 下載廣得好（開新視窗）",
    beliefKicker: "我哋嘅理念",
    ...
    faqs: [
      ...
      [
        "幾時推出？",
        "而家已經正式推出！iPhone／iPad 版可以喺 App Store 下載，Android 版可以喺 Google Play 下載。",
      ],
    ],
    footTitle: "一齊同鴨仔學寫字！",
    footSub: "現已喺 App Store 同 Google Play 推出",
    footCta: "立即下載",
    footSupport: "支援",
    footPrivacy: "私隱政策",
    footTerms: "使用條款（EULA）",
  ...
  en: {
    ...
    badgeSoonTop: "NOW ON iPHONE, iPAD & ANDROID",
    storeBadgesLabel: "Download CanDuckGo",
    appStoreAria: "Download CanDuckGo on the App Store (opens in a new tab)",
    googlePlayAria: "Download CanDuckGo on Google Play (opens in a new tab)",
    ...
    faqs: [
      ...
      [
        "When does it launch?",
        "It's out now! Download the iPhone and iPad version from the App Store, or the Android version from Google Play.",
      ],
    ],
    footTitle: "Learn to write, duck by your side!",
    footSub: "Available now on the App Store and Google Play",
    footCta: "Download now",
    footSupport: "Support",
